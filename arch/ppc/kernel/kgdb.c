...
static void *old_debugger;
static void *old_debugger_bpt;
static void *old_debugger_sstep;
static void *old_debugger_iabr_match;
static void *old_debugger_dabr_match;

int kgdb_arch_init(void)
{
	old_debugger = debugger;
	old_debugger_bpt = debugger_bpt;
	old_debugger_sstep = debugger_sstep;
	old_debugger_iabr_match = debugger_iabr_match;
	old_debugger_dabr_match = debugger_dabr_match;

	debugger = kgdb_debugger;
	debugger_bpt = kgdb_handle_breakpoint;
...
{
	debugger = old_debugger;
	debugger_bpt = old_debugger_bpt;
	debugger_sstep = old_debugger_sstep;
	debugger_iabr_match = old_debugger_iabr_match;
	debugger_dabr_match = old_debugger_dabr_match;
}
